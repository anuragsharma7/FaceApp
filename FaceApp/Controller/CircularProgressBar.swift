...
//  FaceApp
//
//  Created by Divya Pathak on 23/12/2020.
//
...
class CircularProgressBar: UIView {
    ...
    private var radius: CGFloat {
        get{
            if self.frame.width < self.frame.height { return (self.frame.width - lineWidth)/4 }
            else { return (self.frame.height - lineWidth)/4 }
        }
    }
